...
(
	CPage,
	{
	    ...
	    _postData: function() {
	        ...
	        var o = {};
	        o.id = this._oProvider.id.toString();
	        o.name = this._oProvider.sName.replace(/<br \/>|\n/g, " ");
	        o.account = aFields[0].getValue();
            ...
            this._oPostData["_extra_enter_summ_page"] = 'enter_summ_delivery.html';
