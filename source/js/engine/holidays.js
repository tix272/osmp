...
var oHolidays = {
    ...
    "7.1": { name: "Православное Рождество", img: "./img/ui/holidays/7_1.png" },
    "25.1": { name: "День студентов (Татьянин день)", img: "./img/ui/holidays/25_1.png" },
    "14.2": { name: "День святого Валентина (День всех влюбленных)", img: "./img/ui/holidays/14_2.png" },
    ...
    "22.4": { name: "День бренда киви", img: "./img/ui/holidays/22_4.png" },
    ...
    "25.5": { name: "Последний звонок", img: "./img/ui/holidays/25_5.png" },
    //"27.5": { name: "Санкт-петербург 309 лет", img: "./img/ui/holidays/27_5.png" },
    "1.6": { name: "Всемирный день защиты детей", img: "./img/ui/holidays/1_6.png" },
    "6.6": { name: "Пушкинский день России", img: "./img/ui/holidays/6_6.png" },
    "12.6": { name: "День России", img: "./img/ui/holidays/12_6.png" },
    "17.6": { name: "День медицинского работника", img: "./img/ui/holidays/17_6.png" },
    //"24.6": { name: "Новосибирск 119 лет", img: "./img/ui/holidays/24_6.png" },
    "27.6": { name: "День молодежи России", img: "./img/ui/holidays/27_6.png" },
    "3.7": { name: "День ГИБДД", img: "./img/ui/holidays/3_7.png" },
    "8.7": { name: "Всероссийский день семьи, любви и верности", img: "./img/ui/holidays/8_7.png" },
    "9.7": { name: "День российской почты", img: "./img/ui/holidays/9_7.png" },
    "29.7": { name: "День военно-морского флота", img: "./img/ui/holidays/29_7.png" },
    "2.8": { name: "День Воздушно-десантных войск", img: "./img/ui/holidays/2_8.png" },
    //"5.8": { name: "Омск 296 лет", img: "./img/ui/holidays/5_8.png" },
    "12.8": { name: "День Военно-воздушных сил", img: "./img/ui/holidays/12_8.png" },
    "13.8": { name: "День строителя", img: "./img/ui/holidays/13_8.png" },
    //"19.8": { name: "Екатеринбург 289 лет", img: "./img/ui/holidays/19_8.png" },
